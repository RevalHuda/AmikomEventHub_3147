                ...
                <tbody class="divide-y border-t">
                    @forelse ($recentTransactions as $trx)
                        <tr class="hover:bg-slate-50 transition">
                            <td class="px-8 py-6 text-sm text-slate-500">{{ $trx->created_at->format('d M Y') }}</td>
                            <td class="px-8 py-6">
                            ...
                            <td class="px-8 py-6 whitespace-nowrap">
                                ...
                                @else
                                    <span class="px-3 py-1 bg-slate-100 text-slate-600 rounded-lg text-xs font-bold uppercase">{{ ucfirst($trx->status) }}</span>
                                @endif
                            </td>
