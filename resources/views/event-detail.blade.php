...
<body class="bg-slate-50 text-slate-900">
    ...
    <!-- Partners Section -->
    <section class="bg-slate-100 py-16 mt-12">
        <div class="max-w-7xl mx-auto px-6">
            <div class="text-center mb-12">
                <h2 class="text-3xl font-extrabold mb-2">Didukung Oleh Partner Kami</h2>
                <p class="text-slate-600 font-medium">Terima kasih kepada partner yang telah mendukung event ini</p>
            </div>
                        ...
                        <div class="bg-white rounded-2xl p-6 shadow-sm hover:shadow-lg transition flex items-center justify-center min-h-[150px]">
                            <div class="text-center">
                                <img src="{{ $partner->logo_url }}" alt="{{ $partner->name }}"
                                    class="w-full h-full object-contain max-h-[120px] mx-auto mb-2" title="{{ $partner->name }}">
            ...
            @else
                <div class="text-center py-12 bg-white rounded-2xl">
                    <p class="text-slate-500 text-lg">Belum ada partner untuk event ini</p>
                </div>
            @endif
        </div>
    </section>
